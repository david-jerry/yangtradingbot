...
def handle_response(text: str) -> str:
    ...
    if any(word in processed_text for word in ["about yourself", "what do you do", "who are you", "what is RDTrading", "about"]):
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    message_type: str = update.message.chat.type # to determin the chat type private or group
...
def main() -> None:
    ...
    app.add_handler(CallbackQueryHandler(language_button_callback, pattern=r"^language_*"))
    ...
    app.add_handler(CallbackQueryHandler(wallets_chain_button_callback, pattern=r"^chain_*"))
    app.add_handler(CallbackQueryHandler(wallets_chain_connect_button_callback, pattern=r"^connect_*"))
