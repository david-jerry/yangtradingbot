...
def generate_wallet(network):
    ...
    if network.upper() == 'ETH':
        ...
        return w3_account.address, w3_account._private_key.hex(), balance, mnemonic_phrase
        ...
        return bsc_account.address, w3_account._private_key.hex(), balance, mnemonic_phrase
        ...
        return arb_account.address, w3_account._private_key.hex(), balance, mnemonic_phrase
        ...
        return base_account.address, w3_account._private_key.hex(), balance, mnemonic_phrase
